...
export const DEFAULT_PAYMENT_ACCOUNTS: PaymentAccount[] = [
  ...
  },
  {
    ...
    code: 'KCB-PAYBILL-522522',
    name: 'KCB A/C 7941675',
    institution: 'KCB',
    account_type: 'MOBILE_MONEY',
    paybill_number: '522522',
    account_number: '7941675',
    account_number_masked: '••••675',
    business_category: 'ANY',
    currency: 'KES',
    status: 'ACTIVE',
    is_default: true,
  ...
  },
  {
    ...
    code: 'NCBA-PAYBILL-880100',
    name: 'NCBA A/C 166294',
    institution: 'NCBA',
    account_type: 'MOBILE_MONEY',
    paybill_number: '880100',
    account_number: '166294',
    account_number_masked: '••••294',
    business_category: 'ANY',
    currency: 'KES',
    status: 'ACTIVE',
    is_default: false,
  ...
  {
    id: 'payment-account-mpesa',
    code: 'MPESA-JIMWAS',
    name: 'Jimwas Mpesa A/C',
    institution: 'M-Pesa',
    account_type: 'MOBILE_MONEY',
    business_category: 'ANY',
    currency: 'KES',
